...
@OwnedBy(CDP)
public class GcpK8sInfraDelegateConfigTest extends CategoryTest {
  @Test
  @Owner(developers = MLUKIC)
  @Category(UnitTests.class)
  public void toInfraContextEmptyTest() {
    GcpK8sInfraDelegateConfig k8sInfraDelegateConfig = GcpK8sInfraDelegateConfig.builder().build();
