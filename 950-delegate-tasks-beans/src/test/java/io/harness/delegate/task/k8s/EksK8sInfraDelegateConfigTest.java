...
@OwnedBy(CDP)
public class EksK8sInfraDelegateConfigTest extends CategoryTest {
  @Test
  @Owner(developers = MLUKIC)
  @Category(UnitTests.class)
  public void toInfraContextEmptyTest() {
    EksK8sInfraDelegateConfig k8sInfraDelegateConfig = EksK8sInfraDelegateConfig.builder().build();
