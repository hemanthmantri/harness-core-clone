...
@NoArgsConstructor
@AllArgsConstructor
@Schema(name = "ErrorBudgetBurnDown", description = "This is the Error Budget Burn Down entity defined in Harness")
@EqualsAndHashCode()
public class ErrorBudgetBurnDownDTO implements YamlDTO {
