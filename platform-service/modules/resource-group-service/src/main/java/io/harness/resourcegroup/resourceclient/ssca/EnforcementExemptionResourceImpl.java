...
package io.harness.resourcegroup.resourceclient.ssca;
...
@Slf4j
public class EnforcementExemptionResourceImpl implements Resource {
  public static final String SSCA_ENFORCEMENT_EXEMPTION = "SSCA_ENFORCEMENT_EXEMPTION";

  @Override
  public String getType() {
    return SSCA_ENFORCEMENT_EXEMPTION;
  }
