...
public class EcsCanaryDeleteStepV2 extends CdAsyncExecutable<EcsCommandResponse, EcsCanaryDeleteStep> {
  public static final StepType STEP_TYPE = StepType.newBuilder()
                                               .setType(ExecutionNodeType.ECS_CANARY_DELETE_V2.getName())
