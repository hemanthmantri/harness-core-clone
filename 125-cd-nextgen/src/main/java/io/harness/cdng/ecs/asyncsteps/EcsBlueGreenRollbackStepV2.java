...
public class EcsBlueGreenRollbackStepV2 extends CdAsyncExecutable<EcsCommandResponse, EcsBlueGreenRollbackStep> {
  public static final StepType STEP_TYPE = StepType.newBuilder()
                                               .setType(ExecutionNodeType.ECS_BLUE_GREEN_ROLLBACK_V2.getName())
