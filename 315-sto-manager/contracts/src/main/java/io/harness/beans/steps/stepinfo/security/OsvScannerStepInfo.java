...
@TypeAlias("osvScannerStepInfo")
@OwnedBy(STO)
@RecasterAlias("io.harness.beans.steps.stepinfo.security.OsvScannerStepInfo")
public class OsvScannerStepInfo extends STOGenericStepInfo {
  private static final String PRODUCT_NAME = "osv-scanner";
