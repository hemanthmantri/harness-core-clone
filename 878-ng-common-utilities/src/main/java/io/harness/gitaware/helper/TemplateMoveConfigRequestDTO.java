...
@Schema(name = "TemplateMoveConfigRequestDTO", description = "Details to move entity from harness to git")
@OwnedBy(CDC)
@NoArgsConstructor
@AllArgsConstructor
public class TemplateMoveConfigRequestDTO {
  ...
  @Parameter(description = "Version Label")
  @QueryParam(NGCommonEntityConstants.VERSION_LABEL_KEY)
  @NotNull
  String versionLabel;
}