...
public class PlanExecutionSummaryCdChangeServiceInfraChangeDataHandlerNewTest extends CategoryTest {
  ...
  public void testInsertGitOps() throws IOException, SQLException {
    ...
    assertThat(sqls.get(0))
        .isEqualTo(
            "INSERT INTO service_infra_info (env_group_name,pipeline_execution_summary_cd_id,service_name,service_startts,service_endts,deployment_type,env_name,env_id,env_group_ref,service_id,service_status,id,env_type,gitOpsEnabled) VALUES('EnvGroup-1Env','uuid','service2','1671346275772','1671346296079','Kubernetes','EnvProjectLevelAgents','env2','EnvGroup1','service2','Success','gPfCWZ9WQxWOw5miYocUfA','Production','true') ON CONFLICT (id,service_startts) Do UPDATE  SET env_group_name='EnvGroup-1Env',pipeline_execution_summary_cd_id='uuid',service_name='service2',service_startts='1671346275772',service_endts='1671346296079',deployment_type='Kubernetes',env_name='EnvProjectLevelAgents',env_id='env2',env_group_ref='EnvGroup1',service_id='service2',service_status='Success',id='gPfCWZ9WQxWOw5miYocUfA',env_type='Production',gitOpsEnabled='true'");
    assertThat(sqls.get(1))
        .isEqualTo(
            "INSERT INTO service_infra_info (env_group_name,pipeline_execution_summary_cd_id,service_name,service_startts,service_endts,deployment_type,env_name,env_id,env_group_ref,service_id,service_status,id,env_type,gitOpsEnabled) VALUES('EnvGroup-2Env','uuid','service5','1671346298085','1671346316016','Kubernetes','EnvProjectLevelAgents','env2','envGroup','service5','Success','vRVRcCMURs-fUu2oRxjzMA','PreProduction','true') ON CONFLICT (id,service_startts) Do UPDATE  SET env_group_name='EnvGroup-2Env',pipeline_execution_summary_cd_id='uuid',service_name='service5',service_startts='1671346298085',service_endts='1671346316016',deployment_type='Kubernetes',env_name='EnvProjectLevelAgents',env_id='env2',env_group_ref='envGroup',service_id='service5',service_status='Success',id='vRVRcCMURs-fUu2oRxjzMA',env_type='PreProduction',gitOpsEnabled='true'");
    assertThat(sqls.get(2))
        .isEqualTo(
            "INSERT INTO service_infra_info (rollback_duration,pipeline_execution_summary_cd_id,service_name,service_startts,service_endts,deployment_type,service_id,service_status,id,execution_failure_details,gitOpsEnabled) VALUES('46','uuid','service3','1671346316187','1671346326076','Kubernetes','service3','Failed','fkNFsY9YToqnSL4wUfqg8w','No files were committed. Hence not creating a pull request.','true') ON CONFLICT (id,service_startts) Do UPDATE  SET rollback_duration='46',pipeline_execution_summary_cd_id='uuid',service_name='service3',service_startts='1671346316187',service_endts='1671346326076',deployment_type='Kubernetes',service_id='service3',service_status='Failed',id='fkNFsY9YToqnSL4wUfqg8w',execution_failure_details='No files were committed. Hence not creating a pull request.',gitOpsEnabled='true'");
    assertThat(sqls.get(3))
        .isEqualTo(
            "INSERT INTO service_infra_info (env_group_name,pipeline_execution_summary_cd_id,service_name,service_startts,service_endts,deployment_type,env_name,env_id,env_group_ref,service_id,service_status,id,gitOpsEnabled) VALUES('EnvGroup-1Env','uuid','service4','1671346298094','1671346313953','Kubernetes','EnvProjectLevelAgents','env2','EnvGroup1','service4','Success','ev9_xNp0T96yPcfbFe7Mnw','true') ON CONFLICT (id,service_startts) Do UPDATE  SET env_group_name='EnvGroup-1Env',pipeline_execution_summary_cd_id='uuid',service_name='service4',service_startts='1671346298094',service_endts='1671346313953',deployment_type='Kubernetes',env_name='EnvProjectLevelAgents',env_id='env2',env_group_ref='EnvGroup1',service_id='service4',service_status='Success',id='ev9_xNp0T96yPcfbFe7Mnw',gitOpsEnabled='true'");
    assertThat(sqls.get(4))
        .isEqualTo(
            "INSERT INTO service_infra_info (env_group_name,pipeline_execution_summary_cd_id,service_name,service_startts,service_endts,deployment_type,env_name,env_id,env_group_ref,service_id,service_status,id,gitOpsEnabled) VALUES('EnvGroup-1Env','uuid','service1','1671346275754','1671346296111','Kubernetes','EnvProjectLevelAgents','env2','EnvGroup1','service1','Success','FNra8NwISJ2qUWFyz9vPiA','true') ON CONFLICT (id,service_startts) Do UPDATE  SET env_group_name='EnvGroup-1Env',pipeline_execution_summary_cd_id='uuid',service_name='service1',service_startts='1671346275754',service_endts='1671346296111',deployment_type='Kubernetes',env_name='EnvProjectLevelAgents',env_id='env2',env_group_ref='EnvGroup1',service_id='service1',service_status='Success',id='FNra8NwISJ2qUWFyz9vPiA',gitOpsEnabled='true'");
    assertThat(sqls.get(5))
        .isEqualTo(
            "INSERT INTO service_infra_info (rollback_duration,pipeline_execution_summary_cd_id,service_name,service_startts,service_endts,deployment_type,service_id,service_status,id,execution_failure_details,gitOpsEnabled) VALUES('0','uuid','service2','1671346316182','1671346318850','Kubernetes','service2','Failed','M7v0YIX9QsCD1n0S_FuFXA','Invalid request: No GitOps Cluster is selected with the current environment configuration','true') ON CONFLICT (id,service_startts) Do UPDATE  SET rollback_duration='0',pipeline_execution_summary_cd_id='uuid',service_name='service2',service_startts='1671346316182',service_endts='1671346318850',deployment_type='Kubernetes',service_id='service2',service_status='Failed',id='M7v0YIX9QsCD1n0S_FuFXA',execution_failure_details='Invalid request: No GitOps Cluster is selected with the current environment configuration',gitOpsEnabled='true'");
    assertThat(sqls.get(6))
        .isEqualTo(
            "INSERT INTO service_infra_info (env_group_name,pipeline_execution_summary_cd_id,service_name,service_startts,service_endts,deployment_type,env_name,env_id,env_group_ref,service_id,service_status,id,gitOpsEnabled) VALUES('EnvGroup-1Env','uuid','service3','1671346275760','1671346297916','Kubernetes','EnvProjectLevelAgents','env2','EnvGroup1','service3','Success','rA7k-ziARyO4aTxKl4THvA','true') ON CONFLICT (id,service_startts) Do UPDATE  SET env_group_name='EnvGroup-1Env',pipeline_execution_summary_cd_id='uuid',service_name='service3',service_startts='1671346275760',service_endts='1671346297916',deployment_type='Kubernetes',env_name='EnvProjectLevelAgents',env_id='env2',env_group_ref='EnvGroup1',service_id='service3',service_status='Success',id='rA7k-ziARyO4aTxKl4THvA',gitOpsEnabled='true'");
    assertThat(sqls.get(7))
        .isEqualTo(
            "INSERT INTO service_infra_info (env_group_name,pipeline_execution_summary_cd_id,service_name,service_startts,service_endts,deployment_type,env_name,env_id,env_group_ref,service_id,service_status,id,gitOpsEnabled) VALUES('EnvGroup-2Env','uuid','service1','1671346316182','1671346334009','Kubernetes','EnvProjectLevelAgents','env2','envGroup','service1','Success','B9u3mW0yQwCIovStIGzGkg','true') ON CONFLICT (id,service_startts) Do UPDATE  SET env_group_name='EnvGroup-2Env',pipeline_execution_summary_cd_id='uuid',service_name='service1',service_startts='1671346316182',service_endts='1671346334009',deployment_type='Kubernetes',env_name='EnvProjectLevelAgents',env_id='env2',env_group_ref='envGroup',service_id='service1',service_status='Success',id='B9u3mW0yQwCIovStIGzGkg',gitOpsEnabled='true'");
  }
